...
// EXAMPLE 2
   ...
   slides.example2 = slide({
	...
	var sent = "The Patriots won the Super Bowl.";
	var has_val = exp.has_val = false;
...
// EXAMPLE 3
  ...
  slides.example3 = slide({
	...
	dispRow3.append("<div class=targetSen>" + sent + "</div>");
	
        this.init_sliders();
      	exp.sliderPost = {};
	
	dispRow3.appendTo("#sentenceGenerator3");
...
// EXAMPLE 4
  ...
  slides.example4 = slide({
	...
	dispRow3.appendTo("#sentenceGenerator4");
...
log_responses : function() {
  ...
  slides.example5 = slide({
	...
	dispRow3.appendTo("#sentenceGenerator5");
...
log_responses : function() {
 ...
 slides.startExp = slide({
  ...
  slides.generateEntities = slide({
    ...
    contexthtml = context.replace(/###speaker([a-z]+)*((\d+)|([a-z]+))-(\d+)+/g, "<br><b>Speaker #</b>");
 	  contexthtml = contexthtml.replace(/###speaker((\d+)|([a-z]+))-(\d+)*((\d+)|([a-z]+))-(\d+)+/g, "<br><b>Speaker #</b>");
// ###speakera50-1*t50-1
// ###speakeranan*t53-1
// ###speakerbnan*t53-2
// ###speakeranan*t54-2
