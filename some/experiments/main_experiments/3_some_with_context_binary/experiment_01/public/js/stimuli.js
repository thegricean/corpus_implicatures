...
function generate_stim() {
    ...
    const tsvFileData = readFileSync('./corpus01.txt');
    const contents = tsvJSON(tsvFileData.toString());
    ...
    var raw = contents;
        ...
        headings = ["TGrepID","EntireSentence","context","BestResponse"]
